...
def change_output_layers(model):
    model._fc = nn.Linear(1280, classes, bias=True)
    return model
...
if __name__ == "__main__":
    ...
    help_="predict an image"
    parser.add_argument("-p","--predict",help=help_, action="store_true")
    help_="image filename"
    parser.add_argument("-f","--filename",help=help_)
    ...
    dataset_train_dst = r'D:\Side Work Data\LCD photos\Training\Arrangement_train\0522\train1_5cls\dataset_train_lcd.pkl'
    dataset_test_dst = r'D:\Side Work Data\LCD photos\Training\Arrangement_train\0522\test1_5cls\dataset_test_lcd.pkl'
        ...
        for epoch in range(epochs):
            ...
            for i, data in enumerate(train_loader, 1):
                ...
                if(i%display_frequency == 0):
                    print('the current output is ',outputs)
                    # print('the current label is ', labels)
    ...
    if args.filename and args.predict:
